...
<Navbar bg="light" expand="lg" className={(isSticky) ? "navbar  navbar-expand-lg navbar-dark bg-dark fixed-top" : "navbar  navbar-expand-lg navbar-light color text-dark"}>
    <Container>
        <Nav.Link as={NavLink} to="/"><Navbar.Brand href="#home"> 
        <img src="./logo.png" height="50" width="50"/>
         <b>Mildlife Journey</b> </Navbar.Brand></Nav.Link>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto align-items-center">
                ...
                <Nav.Link as={NavLink} to="/galary">GALLERY</Nav.Link>

                <Nav.Link as={NavLink} to="/bookCenter">HOTEL BOOK</Nav.Link>
